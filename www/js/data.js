elephant.constant('elephantData_URL', {
  GET_ALL_ITEM_URL: 'http://test.myelephant.xyz/getitems.php',
  GET_ALL_ITEM_TYPE: 'GET',
  LOGIN_USER_URL: 'http://test.myelephant.xyz/login.php',
  LOGIN_USER_TYPE: 'POST',
  REGISTER_USER_URL: 'http://test.myelephant.xyz/register.php',
  REGISTER_USER_TYPE: 'POST',
  GET_USER_ITEM_URL: 'http://test.myelephant.xyz/myitems.php',
  GET_USER_ITEM_TYPE:'GET',
  DELETE_USER_ITEM_URL: 'http://test.myelephant.xyz/dismiss.php',
  DELETE_USER_ITEM_TYPE: 'POST',
  POST_ITEM_URL: 'http://test.myelephant.xyz/postitem.php',
  POST_ITEM_TYPE: 'POST',
  REQUEST_ITEM_URL: 'http://test.myelephant.xyz/message.php',
  REQUEST_ITEM_TYPE: 'POST',
  RESET_REQUEST_URL: 'http://test.myelephant.xyz/forgotpass_request.php',
  RESET_REQUEST_TYPE: 'POST',
  RESET_VERIFY_URL: 'http://test.myelephant.xyz/forgotpass_verify.php',
